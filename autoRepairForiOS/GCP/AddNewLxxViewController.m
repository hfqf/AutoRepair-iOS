...
- (void)viewDidLoad {
    ...
    [self.m_input setFont:[UIFont systemFontOfSize:16]];
...
- (void)addBtnClicked
{
        ...
        [HTTP_MANAGER addNewBBS:[LoginUserUtil singnalTel]
                 ...
                 successedBlock:^(NSDictionary *succeedResult) {
                     ...
                     if([succeedResult[@"code"]integerValue]==1){
                         ...
                         [self performSelector:@selector(refershParent) withObject:nil afterDelay:0.5];
    ...
    for(UIImage *img in self.selectedPhotos){
        ...
        NSString *path = [LocalImageHelper saveImage:img];

        NSString *fileName = [NSString stringWithFormat:@"%@",[LocalTimeUtil getCurrentTime3]];
        [HTTP_MANAGER uploadBOSFile:path
                     ...
                     successedBlock:^(NSDictionary *succeedResult) {
                         ...
                         if([succeedResult[@"code"]integerValue] == 1)
                         {
                             ...
                             [self.m_arrFilePics addObject:newHead];
                             count++;
