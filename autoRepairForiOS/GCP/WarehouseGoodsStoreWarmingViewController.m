//
//  WarehouseGoodsStoreWarmingViewController.m
//  AutoRepairHelper3
//
...
#import "WarehouseGoodsStoreWarmingViewController.h"

#import "WarehouseGoodsInfoViewController.h"
@interface WarehouseGoodsStoreWarmingViewController ()<UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate>

@end

@implementation WarehouseGoodsStoreWarmingViewController
...
- (void)requestData:(BOOL)isRefresh
{
    ...
    [HTTP_MANAGER getAllWarmingGoodsStoreList:^(NSDictionary *succeedResult) {
