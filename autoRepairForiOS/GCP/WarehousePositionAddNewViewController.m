...
@interface WarehousePositionAddNewViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
...
@implementation WarehousePositionAddNewViewController
...
- (void)addBtnClicked
{
    ...
    [HTTP_MANAGER addNewWarehousePositionWith:self.m_value1
                                   withRemark:self.m_value2 == nil ? @"" : self.m_value2
                              withWarehouseId:self.m_warehouseInfo[@"_id"]
