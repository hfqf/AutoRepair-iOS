...
{
    NSString *str = [[NSUserDefaults standardUserDefaults]objectForKey:KEY_CURRENT_SKIN];
    //先以16为参数告诉strtoul字符串参数表示16进制数字，然后使用0x%X转为数字类型
    unsigned long red1 = strtoul([str UTF8String],0,16);
//    //strtoul如果传入的字符开头是“0x”,那么第三个参数是0，也是会转为十六进制的,这样写也可以：
//    unsigned long red2 = strtoul([@"0x6587" UTF8String],0,0);
    return red1;
}

+ (unsigned long)getCurrentSkin:(NSString *)hex
{
    unsigned long red1 = strtoul([hex UTF8String],0,16);
    return red1;
}
