//
//  WarehousePurchaseRejectedViewController.m
//  AutoRepairHelper3
//
...
#import "WarehousePurchaseRejectedViewController.h"
#import "WarehouseGoodsInfoViewController.h"
#import "WarehouseGoodsRejectViewController.h"
@interface WarehousePurchaseRejectedViewController ()<UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate>
...
{
    WareHouseGoods *good = [self.m_arrData objectAtIndex:indexPath.row];
    WarehouseGoodsRejectViewController *info = [[WarehouseGoodsRejectViewController alloc]initWith:good];
