...
#pragma  mark - ------------------------------------------------  每次换不同省时,必须要换的几个宏 ------------------------------------------------

#define  BJ_SERVER_TYPE_32      32
#define  BJ_SERVER_TYPE_95      95
#define  BJ_SERVER_TYPE_96      96
#define  BJ_SERVER_TYPE_PRODUCTION  BJ_SERVER_TYPE_96   ///< 生产服务器，正式环境地址

////////////////////////////////////////////////////////////////////////
///< 切换服务器，请配置这个宏
#define BJ_SERVER_TYPE      BJ_SERVER_TYPE_PRODUCTION

////////////////////////////////////////////////////////////////////////

#if BJ_SERVER_TYPE == BJ_SERVER_TYPE_PRODUCTION

#define  BJ_SERVER1          @"http://112.33.2.96:9002"
#define  BJ_SERVER           @"http://112.33.2.96"
#define  IM_CHAT_WS_SERVER   @"ws://112.33.2.96:9100/im"

#elif BJ_SERVER_TYPE == BJ_SERVER_TYPE_95

#define  BJ_SERVER1          @"http://112.33.2.95:8882"
#define  BJ_SERVER           @"http://112.33.2.95:9000"
#define  IM_CHAT_WS_SERVER   @"ws://112.33.2.95:8884/im"

#elif BJ_SERVER_TYPE == BJ_SERVER_TYPE_32

#define  BJ_SERVER1          @"http://112.33.2.32:9002"
#define  BJ_SERVER           @"http://112.33.2.32:9000"
#define  IM_CHAT_WS_SERVER   @"ws://112.33.2.32:9100/im"

#endif

#define  IM_FILE_SERVER     BJ_SERVER1
...
#define  KEY_COMMON_CORLOR                    UIColorFromRGB(0x23d5b5)
